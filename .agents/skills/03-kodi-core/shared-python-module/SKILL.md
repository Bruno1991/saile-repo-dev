---
name: shared-python-module
title: Módulo Python compartilhado
skill_id: 03.11
category: kodi-core
version: 2.0.0
applies_to:
...
Extrair somente infraestrutura estável para script.module.saile.core sem mover regras de negócio.
