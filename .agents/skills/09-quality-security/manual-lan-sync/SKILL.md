---
name: manual-lan-sync
title: Sincronização LAN manual
skill_id: 09.11
category: quality
version: 2.0.0
applies_to:
...
Sincronizar registros entre dispositivos somente por ação explícita, sem compartilhar SQLite ou segredos.
