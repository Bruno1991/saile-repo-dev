...
AGENTS defines how human contributors and autonomous AI agents operate inside the SAILE Engineering Framework.
...
Agents must read documentation first, preserve architectural integrity, avoid production addon implementation during framework phases and update status, backlog, decisions and risks when their work changes project state.
