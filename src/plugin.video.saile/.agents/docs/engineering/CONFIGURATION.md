...
Configuration defines engineering process, quality gates and maintainability rules for the SAILE project.
...
- Settings ownership includes defaults, validation, migration, local persistence and user-controlled overrides.
