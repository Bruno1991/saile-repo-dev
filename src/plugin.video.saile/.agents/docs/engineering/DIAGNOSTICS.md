...
Diagnostics defines engineering process, quality gates and maintainability rules for the SAILE project.
...
- Defines contributor behavior, review gates and maintainability standards before implementation begins.
- Must be enforceable by code review, documentation review and future automation.
