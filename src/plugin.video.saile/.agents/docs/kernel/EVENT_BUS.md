...
Event Bus defines a Kernel subsystem that coordinates local runtime behavior without owning business rules.
...
- Event Bus ownership includes immutable local events, subscriber isolation and bounded dispatch.
