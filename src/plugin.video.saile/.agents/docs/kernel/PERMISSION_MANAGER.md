...
Permission Manager defines a Kernel subsystem that coordinates local runtime behavior without owning business rules.
...
- Permission ownership includes explicit grants, denials, auditability and Plugin least privilege.
