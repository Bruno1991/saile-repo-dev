...
Scheduler defines a Kernel subsystem that coordinates local runtime behavior without owning business rules.
...
- Scheduler ownership includes task ownership, timeouts, cancellation, prioritization and resource-aware concurrency.
