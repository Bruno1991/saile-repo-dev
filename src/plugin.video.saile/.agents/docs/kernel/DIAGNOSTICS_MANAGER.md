...
Diagnostics Manager defines a Kernel subsystem that coordinates local runtime behavior without owning business rules.
...
- Observability ownership is local-only and must redact secrets before logs, metrics or diagnostics are emitted.
