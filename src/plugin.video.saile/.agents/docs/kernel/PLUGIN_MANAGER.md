...
Plugin Manager defines a Kernel subsystem that coordinates local runtime behavior without owning business rules.
...
- Plugin Manager ownership includes discovery, manifest validation, dependency validation, permission validation, loading, health and unloading.
