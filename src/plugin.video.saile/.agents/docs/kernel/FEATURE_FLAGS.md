...
Feature Flags defines a Kernel subsystem that coordinates local runtime behavior without owning business rules.
...
- Feature flags may control optional behavior but must never replace architecture or hide incomplete contracts.
