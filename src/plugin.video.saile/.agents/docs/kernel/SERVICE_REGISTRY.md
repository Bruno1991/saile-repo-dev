...
Service Registry defines a Kernel subsystem that coordinates local runtime behavior without owning business rules.
...
- Service Registry ownership includes Kernel service contracts and replacement-safe service lookup.
