...
Capability SDK defines contract rules for contributors who build against SAILE extension surfaces.
...
- Defines contributor-facing contracts for Plugins, Capabilities or Engines.
- Must be versioned, migration-friendly and explicit about compatibility.
...
### Playback Capability (`media.playback`)
- **Request:** `{"item_id": "string", "resume_point": "int"}`
- **Response:** `{"stream_url": "string", "subtitles": ["string"]}`

### Search Capability (`media.search`)
- **Request:** `{"query": "string", "filters": {"year": "int"}}`
- **Response:** `{"results": [{"id": "string", "title": "string"}]}`

### Metadata Capability (`media.metadata`)
- **Request:** `{"item_id": "string"}`
- **Response:** `{"title": "string", "plot": "string", "cast": ["string"]}`
