...
Capability Architecture defines architectural boundaries, dependency direction and Kernel-mediated design for SAILE.
...
- Defines structural boundaries for Runtime, Kernel, registries, Media Engines, Plugins and the Presentation Layer.
- Must reject any flow that lets Kodi or a Plugin bypass Kernel mediation.
