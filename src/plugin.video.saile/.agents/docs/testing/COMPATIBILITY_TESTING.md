...
Compatibility Testing defines validation practices that protect architecture, behavior and compatibility.
...
- Defines evidence required before behavior is accepted.
- Must include architecture, contract, security, privacy, performance and compatibility validation where applicable.
