...
HTTP captures technical knowledge required to design SAILE without violating architecture.
...
- HTTP knowledge applies to Plugin or infrastructure adapters only; Engines must not perform direct HTTP.
