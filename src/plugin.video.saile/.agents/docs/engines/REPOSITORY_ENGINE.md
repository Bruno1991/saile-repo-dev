...
Repository Engine defines a Media Engine business workflow that consumes Capabilities through the Kernel.
...
- Defines a business workflow owner that consumes Capabilities through the Kernel.
- Must own ranking, validation, state transitions and business recovery for its domain.
