...
No Telemetry Policy defines Local-First privacy guarantees and user data boundaries.
...
- Defines Local-First user-data guarantees.
- Must prohibit hidden telemetry, analytics, remote accounts and SAILE-owned data collection.
