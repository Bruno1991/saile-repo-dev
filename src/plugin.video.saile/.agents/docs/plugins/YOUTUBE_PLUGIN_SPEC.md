...
Youtube Plugin Spec defines Plugin authoring rules for isolated local modules implementing Capabilities.
...
- YouTube work is limited to Plugin-owned search, metadata and playable-source Capabilities compatible with YouTube policy and user configuration.
