...
Torrent Plugin Spec defines Plugin authoring rules for isolated local modules implementing Capabilities.
...
- Torrent work must be isolated behind explicit user-enabled Plugin permissions and must never create a SAILE daemon or background service.
