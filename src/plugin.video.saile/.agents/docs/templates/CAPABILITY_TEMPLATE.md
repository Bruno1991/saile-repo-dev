...
This template defines the required structure for a SAILE Capability artifact.
...
- Defines a reusable artifact form that prevents missing architectural evidence.
- Must be copied only into SAILE-specific completed documents with real decisions and review data.
