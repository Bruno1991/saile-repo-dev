# SAILE Engineering Handbook README
...
This README explains how the SAILE Engineering Handbook is organized and how contributors should navigate it.
...
Start with the Master Specification, then Engineering Constitution, Architecture, Domain, Kernel, Runtime, SDK, Engines, Plugins, Security, Privacy, Performance, Testing and AI workflow documents.
