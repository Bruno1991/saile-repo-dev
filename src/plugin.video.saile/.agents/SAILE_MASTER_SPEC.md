...
The SAILE Master Specification is the top-level product and platform authority for the Local-First Media Runtime.
...
SAILE is not a cloud platform, streaming service, backend server, SaaS product, telemetry platform, remote synchronization service, centralized media server, daemon, background operating system service or microservice architecture.

## Official Component Vocabulary

Runtime, Kernel, Plugin Manager, Capability Registry, Service Registry, Engine Registry, Event Bus, Scheduler, Resource Manager, Permission Manager, Metrics Manager, Diagnostics Manager, Logging Manager, Configuration Manager, Feature Flag Manager, Media Engine, Plugin, Capability and Presentation Layer are the official architectural terms.
