...
The Search Engineer skill defines how an autonomous or human-assisted engineering contributor acts when working on SAILE.

Search Engineer defines an AI engineering role with authority, inputs, outputs and review checklists.

## Responsibilities

The Search Engineer is responsible for:
...
The Search Engineer may decide local documentation structure and subject-specific review guidance.

The Search Engineer must escalate when a change affects Kernel responsibilities, Capability contracts, Plugin permissions, Local-First guarantees, security posture, privacy policy or public SDK contracts.
...
Work performed by the Search Engineer is acceptable when it strengthens architectural integrity, is traceable to authoritative documents, is reviewable by maintainers and does not start production addon implementation.
...
- Search ownership includes query normalization, bounded parallel Capability execution, merge, deduplication, ranking and partial-result behavior.
