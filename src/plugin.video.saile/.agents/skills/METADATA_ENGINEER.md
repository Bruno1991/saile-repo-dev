...
The Metadata Engineer skill defines how an autonomous or human-assisted engineering contributor acts when working on SAILE.

Metadata Engineer defines an AI engineering role with authority, inputs, outputs and review checklists.

## Responsibilities

The Metadata Engineer is responsible for:
...
The Metadata Engineer may decide local documentation structure and subject-specific review guidance.

The Metadata Engineer must escalate when a change affects Kernel responsibilities, Capability contracts, Plugin permissions, Local-First guarantees, security posture, privacy policy or public SDK contracts.
...
Work performed by the Metadata Engineer is acceptable when it strengthens architectural integrity, is traceable to authoritative documents, is reviewable by maintainers and does not start production addon implementation.
...
- Metadata ownership includes identity matching, merge policy, freshness, cache policy and conflict diagnostics.
