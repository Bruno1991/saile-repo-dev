...
The Engineering Constitution defines immutable engineering laws for all SAILE contributors and automation.
...
Architecture has priority over implementation. Implementation has priority over optimization. Optimization has priority over convenience. Documentation is part of the software and must precede production code.
